...
export function FixedSidebar() {
  ...
  return (
    <>
      {/* Mobile top bar */}
      <header
        className={`lg:hidden fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-md border-b border-border px-6 py-4 flex items-center justify-between transition-transform duration-300 ${
